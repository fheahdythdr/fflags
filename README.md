...
the directories with Vulkan, D3D11 and D3D10 at the end have the FFlagDebug for using those specific engines enabled, D3D10 is FFlagDebugGraphicsPreferD3D11FL10 for some reason.
